...
class ChattyStudent(Student):
    ...
    # 2. Write a method in the ChattyStudent class, raise_hand(), that uses super() ten times so that the method will print() out "Pick me!" ten times. It is possible to call super() multiple times in a method.
    def raise_hand(self):
        for _ in range(10):
            super().raise_hand()
